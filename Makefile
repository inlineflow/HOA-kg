...
live/server:
	...
	--build.cmd "go build -o tmp/bin/main cmd/hoa/main.go" --build.bin "tmp/bin/main" --build.delay "100" \
...
live/tailwind:
	pnpx @tailwindcss/cli -i ./input.css -o ./assets/css/styles.css --minify --watch
