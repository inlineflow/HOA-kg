...
func BaseLayout(title string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "</title><link rel=\"stylesheet\" href=\"/assets/css/styles.css\"></head><body><header><div class=\"flex flex-col items-center justify-center\"><p class=\"text-3xl font-bold\">CONTACTS.APP</p><p class=\"text-xl\">A demo contacts application </p></div></header><main class=\"mt-8\"><div class=\"flex items-center justify-center\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
